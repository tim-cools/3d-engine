...
test('subtract triangle 1 point 1', async () => {
...
test('subtract triangle 2 segment ac line', async () => {
...
test('subtract triangle 3 segment ac corner', async () => {
...
test('subtract triangle 4 segment ac corner', async () => {
...
test('subtract triangle 5 segment ab line', async () => {
...
test('subtract triangle 6 segment ab corner', async () => {
...
test('subtract triangle 7 point 3', async () => {
...
test('subtract triangle 8 segment bc line', async () => {
