...
test('subtract faces triangle 1 intersect segment bc', async () => {
...
test('subtract faces triangle 2 intersect 2 point ca', async () => {
...
test('subtract faces triangle 3 intersect 1 point ca', async () => {
...
test('subtract faces triangle 4 no intersect', async () => {
...
test('subtract faces triangle 5 intersect 1 point bc - ca', async () => {
...
test('subtract faces triangle 6 intersect 1 point bc segment ca', async () => {
...
test('subtract faces triangle 7 intersect 2 point bc', async () => {
...
test('subtract faces triangle 8 intersect 1 point bc', async () => {
...
test('subtract faces triangle 9 no intersect above', async () => {
