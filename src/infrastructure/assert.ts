export class Assert {
  static notNull<TValue>(value: TValue | null | undefined, name: string): TValue {
    if (value == null) {
  ...
  static is<TValue>(castFunction: (object: any) => TValue | null, value: any, name: string): TValue {
  ...
  static false(value: boolean, name: string) {
    if (value) {
