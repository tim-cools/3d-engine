...
import {Cube, Object, RenderStyle, Overlay, Raster, Sphere} from "../objects"
...
export function cubesAndSphere(): Scene {
  return new Scene("cubes and sphere", new Lazy<Object[]>(() => [
    ...
    new Cube("cube.0", new Point(.5, 0, 0), new Size(.2, .2, .2), RenderStyle.Solid),
    new Cube("cube.1", new Point(-.5, 0, 0), new Size(.2, .2, .2)),
    new Cube("cube.2", new Point(0, .5, 0), new Size(.2, .2, .2), RenderStyle.Solid),
